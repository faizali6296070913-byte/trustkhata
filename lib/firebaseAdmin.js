...
// ---- বদলানো হয়েছে: "export" যোগ করা হলো, যাতে cron job এর জন্য নতুন lib/firestoreAdmin.js এটা ব্যবহার করতে পারে ----
export async function getAccessToken() {
  ...
  const claim = {
    ...
    scope:
      "https://www.googleapis.com/auth/identitytoolkit https://www.googleapis.com/auth/firebase https://www.googleapis.com/auth/datastore",
